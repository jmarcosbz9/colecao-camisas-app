<template>
  <div v-if="open" class="otc-backdrop" @mousedown.self="onBackdropMouseDown">
    ...
    >
      ...
      <form class="otc-body" @submit.prevent="submitUpdate" spellcheck="false">
...
props: {
  ...
  methods: {
    ...
    onConfirmDeletePv(it){
      // Opção B: marca para apagar e só executa no Salvar (backend faz diff old→kept)
...
applyItemToForm() {
      ...
      // preenche campos existentes (mantém estrutura do resetForm)
      this.form.Equipe = (it.Equipe != null) ? String(it.Equipe) : (this.form.Equipe || "");
      this.form.Fornecedora = (it.Fornecedora != null) ? String(it.Fornecedora) : (this.form.Fornecedora || "");
      this.form.fornecedora_id = (it.fornecedora_id != null) ? it.fornecedora_id : (this.form.fornecedora_id || null);
      this.form.Manga = (it.Manga != null) ? String(it.Manga) : (this.form.Manga || "");
      this.form.Conservacao = (it.Conservacao != null) ? String(it.Conservacao) : (this.form.Conservacao || "");
      this.form.Periodo = (it.Periodo != null) ? String(it.Periodo) : (this.form.Periodo || "");
      this.form.Modelo = (it.Modelo != null) ? String(it.Modelo) : (this.form.Modelo || "");
      this.form.Numero = (it.Numero != null) ? String(it.Numero) : (this.form.Numero || "");
      this.form.Observacoes = (it.Observacoes != null) ? String(it.Observacoes) : (this.form.Observacoes || "");
    ...
    _getDraftKey() {
      ...
      const rid = this.editId != null ? String(this.editId) : "unknown";
...
this.enumOptions.Manga = Array.isArray(j.Manga) ? j.Manga : [];
    ...
    async submitUpdate() {
      ...
      if (this.editId == null) {
        this.errors = { _global: "Registro inválido para edição." };
        return;
      }
      ...
      try {
        ...
        const url = "/api/outros_times/" + this.editId;

        if (this.photoItems && this.photoItems.length) {
